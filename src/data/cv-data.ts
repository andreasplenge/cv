...
export const generalInfo: CVGeneralInfo = {
  ...
  title: "Coding Mathematician",
  summary: "Quantitative Engineer with experience in stabilizing the energy grid. I combine a hybrid background in mathematics and software engineering to design scalable analytical tools and model complex decision systems. I have a strong foundation in dynamical systems, probability, and programming, and I am motivated by solving data-driven problems in performance-sensitive environments, particularly those involving uncertainty, forecasting, and optimization.",
  email: "andreas@plenge.tech",
...
export const experience: CVExperience[] = [
  {
    ...
    description: "Designed and developed the core grid stabilization algorithm, orchestrating real-time coordination of household devices using scalable combinatorial methods and linear-complexity optimizations. Conducted code reviews and collaborated with the team to ensure robustness and maintainability.",
...
export const selectedWork: CVSelectedWork[] = [
  {
    ...
    tags: ["Python"],
    full_description: "This is the big deal\n",
    features: [],
    tech_stack: [],
    order_index: 0,
